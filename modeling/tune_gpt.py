...
def main():
    ...
    parser.add_argument('--khan-dataroot', default='./../AMPS/amps/khan', type=str) # original default = None
    ...
    parser.add_argument('--mathematica-dataroot', default='./../AMPS/amps/mathematica', type=str, action='append') # original default = None
